...
class Solution {
    ...
    // The dp array will store the minimum cost to cover all travel days up to each day.
    // For each travel day, we'll evaluate the three ticket options (1-day, 7-day, 30-day)
    // and choose the one that results in the lowest cost.
    // Non-travel days simply inherit the cost from the previous day.
